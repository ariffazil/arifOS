    ...
    def __init__(
        ...
        *,
        ...
        data = {
            ...
            or _hash({"case_id": case.case_id, "input": case.inputs, "evidence": case.evidence}),
            "judgment": verdict,
            "active_holds": active_holds or [],
            "judge_state_hash": _hash(
                {"case_id": case.case_id, "verdict": verdict, "active_holds": active_holds or []}
            ),
            "case_id": case.case_id,
            "trace_id": case.trace_id,
        }
