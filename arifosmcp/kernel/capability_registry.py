...
def _build_default_graph() -> CapabilityGraph:
    ...
    capabilities: list[CapabilityNode] = [
        ...
        # ── GEOX judgment-lane tools (claim create/validate/challenge/seal) ──
        CapabilityNode(
            capability_id="organ.geox.claim",
            tool_name="geox_claim",
            server_id="geox",
            description="GEOX claim lifecycle — create, validate, challenge, seal evidence claims",
            authority_required=AuthorityTier.HIGH,
            mutation_class=MutationClass.ORG_STATE,
            irreversible=False,
            blast_radius=BlastRadius.ORGAN,
        ...
        # ── GEOX prospect / JUDGMENT-lane tools (added 2026-07-14 P0.2) ──
        CapabilityNode(
            capability_id="organ.geox.prospect",
            tool_name="geox_prospect",
            server_id="geox",
            description="GEOX prospect evaluation — volumetrics, POS, EVOI, risk (JUDGMENT lane)",
            authority_required=AuthorityTier.HIGH,
            mutation_class=MutationClass.ORG_STATE,
            irreversible=False,
            blast_radius=BlastRadius.ORGAN,
        ...
        CapabilityNode(
            capability_id="organ.geox.basin",
            tool_name="geox_basin",
            server_id="geox",
            description="GEOX unified basin intelligence — profile, resolve, macrostrat, backstrip",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.petrophysics",
            tool_name="geox_petrophysics",
            server_id="geox",
            description="GEOX petrophysics — Vsh, porosity, Sw, permeability, net pay, LEM inference",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.deep_time_state",
            tool_name="geox_deep_time_state",
            server_id="geox",
            description="GEOX Earth State Vector through deep time — GPTS, CO2, sea level, temperature",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.geomechanics",
            tool_name="geox_geomechanics",
            server_id="geox",
            description="GEOX geomechanical analysis — bulk/shear/young modulus, AI, stress polygon",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.gravmag_studio",
            tool_name="geox_gravmag_studio",
            server_id="geox",
            description="GEOX gravity/magnetic studio — forward modeling and screening",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.seismic_compute",
            tool_name="geox_seismic_compute",
            server_id="geox",
            description="GEOX unified seismic computation — synthetic, well_tie, attribute, inversion",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.seismic_ingest",
            tool_name="geox_seismic_ingest",
            server_id="geox",
            description="GEOX SEG-Y I/O, header inspection, export",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.LOCAL_STATE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.seismic_interpret",
            tool_name="geox_seismic_interpret",
            server_id="geox",
            description="GEOX unified seismic interpretation — horizon/fault picking, RSI, vision",
            authority_required=AuthorityTier.HIGH,
            mutation_class=MutationClass.ORG_STATE,
            irreversible=False,
            blast_radius=BlastRadius.ORGAN,
        ...
        CapabilityNode(
            capability_id="organ.geox.sequence",
            tool_name="geox_sequence",
            server_id="geox",
            description="GEOX unified stratigraphy — sequence analysis, biostratigraphic parsing",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.subsurface_model",
            tool_name="geox_subsurface_model",
            server_id="geox",
            description="GEOX subsurface model building — joint inversion, grav/mag/MT forward",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.surface_status",
            tool_name="geox_surface_status",
            server_id="geox",
            description="GEOX federation-standard registry probe — tool discovery and health status",
            authority_required=AuthorityTier.LOW,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.well_desk",
            tool_name="geox_well_desk",
            server_id="geox",
            description="GEOX well desk — interactive view, publish rendered panel",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="organ.geox.well_ingest",
            tool_name="geox_well_ingest",
            server_id="geox",
            description="GEOX well log ingestion — LAS, SEG-Y, DST, deviation, tops",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.LOCAL_STATE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        # ── Diagnostic tools (MCP-registered, must be in seed graph) ──────
        CapabilityNode(
            capability_id="diagnostic.arif_organ_attest",
            tool_name="arif_organ_attest",
            server_id="local",
            description="Attest a single federation organ",
            authority_required=AuthorityTier.LOW,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="diagnostic.arif_organ_attest_all",
            tool_name="arif_organ_attest_all",
            server_id="local",
            description="Attest all federation organs",
            authority_required=AuthorityTier.LOW,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="diagnostic.arif_floor_status",
            tool_name="arif_floor_status",
            server_id="local",
            description="Report status of all constitutional floors",
            authority_required=AuthorityTier.LOW,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="diagnostic.arif_heartbeat",
            tool_name="arif_heartbeat",
            server_id="local",
            description="Federation heartbeat probe",
            authority_required=AuthorityTier.LOW,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="diagnostic.arif_session_budget",
            tool_name="arif_session_budget",
            server_id="local",
            description="Session budget status",
            authority_required=AuthorityTier.LOW,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="diagnostic.arif_organ_consensus",
            tool_name="arif_organ_consensus",
            server_id="local",
            description="Cross-organ consensus request",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.ORGAN,
        ...
        CapabilityNode(
            capability_id="diagnostic.arif_scan_local_instructions",
            tool_name="arif_scan_local_instructions",
            server_id="local",
            description="Scan for hidden instructions",
            authority_required=AuthorityTier.MEDIUM,
            mutation_class=MutationClass.LOCAL_STATE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
        ...
        CapabilityNode(
            capability_id="diagnostic.arif_stack_health_probe",
            tool_name="arif_stack_health_probe",
            server_id="local",
            description="Probe federation health stack",
            authority_required=AuthorityTier.LOW,
            mutation_class=MutationClass.NONE,
            irreversible=False,
            blast_radius=BlastRadius.LOCAL,
    ...
    version = GraphVersion(
        version_id="v0.2.3",
        description="Capability Graph v0.2.3 — added 8 diagnostic tools (organ_attest, floor_status, heartbeat, etc.) to seed. 2026-07-02.",
    )
