...
def _get_tools(organ: str) -> list[str]:
    ...
    tools = {
        ...
        "WEALTH": [
            "wealth_power_consequence_map",
            "wealth_metric_purpose_audit",
            "wealth_responsibility_ledger",
            "wealth_trust_capital_decay",
            "wealth_coercive_order_cost",
            "wealth_entropy_externality",
        ],
        "GEOX": [
        ...
        "AFORGE": [
            "forge_entropy_schema",
            "forge_dark_geometry_detector",
            "forge_detector_test_corpus",
            "forge_counterfactual_test",
            "forge_calibration_report",
            "forge_prompt_injection_test",
        ],
    }
