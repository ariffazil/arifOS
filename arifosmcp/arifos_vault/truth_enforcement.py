...
def enforce_claim(
    *,
    ...
    layer = assign_evidence_layer(
        has_sealed_canon=bool(existing_receipt and (isinstance(existing_receipt, dict) and existing_receipt.get("evidence_layer") == "L1")),
    ...
    contract["enforcement_note"] = "Generated by truth_enforcement; attach real source hash + kernel signature for L1/L2 elevation."
    if evidence_refs:
...
def hermes_claim_to_receipt(
    ...
    return {
        ...
        "recommendation": "Proceed only within contract" if allowed else "HOLD — obtain receipt or downgrade action",
    }
...
AAA_WARGA_REGISTRY: dict[str, dict] = {
    "hermes": {"issuer": "hermes-000libra", "scope": ["HERMES", "arifOS", "AAA"], "authority": "operator"},
    "hermes-asi": {"issuer": "hermes-asi", "scope": ["HERMES", "arifOS", "AAA"], "authority": "operator"},
    "openclaw": {"issuer": "openclaw", "scope": ["OPENCLAW", "AAA", "arifOS"], "authority": "operator"},
    "opencode": {"issuer": "opencode", "scope": ["OPENCODE", "A-FORGE", "AAA", "arifOS"], "authority": "operator"},
    "grok": {"issuer": "grok-build", "scope": ["GROK", "AAA", "*"], "authority": "operator"},
    "grok-build": {"issuer": "grok-build", "scope": ["GROK", "AAA", "*"], "authority": "operator"},
    "333-agi": {"issuer": "333-agi", "scope": ["333-AGI", "AAA", "arifOS"], "authority": "operator"},
    "555-asi": {"issuer": "555-asi", "scope": ["555-ASI", "AAA", "arifOS"], "authority": "operator"},
    "777-forge": {"issuer": "777-forge", "scope": ["777-FORGE", "A-FORGE", "AAA", "arifOS"], "authority": "operator"},
    "888-apex": {"issuer": "888-apex", "scope": ["888-APEX", "AAA", "arifOS"], "authority": "kernel"},
    "a-audit": {"issuer": "a-audit", "scope": ["A-AUDIT", "AAA", "arifOS"], "authority": "operator"},
