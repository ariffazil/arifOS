...
|| **HTTP** | Web clients, mobile apps, third-party integrations | `http://localhost:8088/mcp` (default; live VPS: `8088`) |
|| **SSE** | Server-sent events for streaming | `http://localhost:8088/sse` (default; live VPS: `8088`)
