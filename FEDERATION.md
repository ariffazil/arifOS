...
> ⚠️ **SUPERSEDED (2026-09-14).** This is a historical snapshot (auto-generated 2026-07-25, `fed-phase-7-zen`), preserved as-is for record — its organ table below still lists HERMES as a core organ, which this federation no longer treats as accurate. **Canonical, current federation topology: [FEDERATION_CONTRACT.md](FEDERATION_CONTRACT.md).** Do not cite this file's organ table as current.
